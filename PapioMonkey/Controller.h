...
class Controller: public Service,public IConnectionListener, public std::enable_shared_from_this<Controller> {
...
private:
    ...
    void workTimedTask();
    void resetStatus();
    void onDeviceStatusQuery(const std::shared_ptr<MessageDeviceStatusQuery>& msg);
